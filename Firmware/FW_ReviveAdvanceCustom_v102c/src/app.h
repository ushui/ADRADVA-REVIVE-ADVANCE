...
// 全体 設定
#define ALL_SETTING_NUM                 5       // 設定数 all 5
#define ALL_DATA_LEN                    0x01    // ALL設定データ長

#define ALL_SETTING_SW_SMPL_INTERVAL_MIN         1    /* デジタルサンプリング周期設定最小値 */
#define ALL_SETTING_SW_SMPL_INTERVAL_MAX         255  /* デジタルサンプリング周期設定最大値 */
#define ALL_SETTING_SW_SMPL_INTERVAL_DEFAULT     4    /* デジタルサンプリング周期デフォルト値 */
#define ALL_SETTING_SW_CHECK_COUNT_MIN           1    /* デジタル一致検出回数設定最小値 */
#define ALL_SETTING_SW_CHECK_COUNT_MAX           255  /* デジタル一致検出回数設定最大値 */
#define ALL_SETTING_SW_CHECK_COUNT_DEFAULT       2    /* デジタル一致検出回数デフォルト値 */
#define ALL_SETTING_SW_RENC_CONV_ENABLES_MIN     0    /* ロータリーエンコーダ設定最小値(0x00000000) */
#define ALL_SETTING_SW_RENC_CONV_ENABLES_MAX     127  /* ロータリーエンコーダ設定最大値(0x01111111) */
#define ALL_SETTING_SW_RENC_CONV_ENABLES_DEFAULT 0    /* ロータリーエンコーダ設定デフォルト値 */
#define ALL_SETTING_SW_RENC_CHECK_COUNT_MIN      1    /* ロータリーエンコーダ一致検出回数設定最小値 */
#define ALL_SETTING_SW_RENC_CHECK_COUNT_MAX      255  /* ロータリーエンコーダ一致検出回数設定最大値 */
#define ALL_SETTING_SW_RENC_CHECK_COUNT_DEFAULT  1    /* ロータリーエンコーダ一致検出回数デフォルト値 */
#define ALL_SETTING_AN_SMPL_INTERVAL_MIN         1    /* アナログサンプリング周期設定最小値 */
#define ALL_SETTING_AN_SMPL_INTERVAL_MAX         255  /* アナログサンプリング周期設定最大値 */
#define ALL_SETTING_AN_SMPL_INTERVAL_DEFAULT     12   /* アナログサンプリング周期デフォルト値 */
