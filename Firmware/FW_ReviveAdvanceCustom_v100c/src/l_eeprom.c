...
// 設定情報
UN_ALL_SETTING_INFOS my_all_infos;     // [1*5byte]=5 全体設定情報読み込みバッファ
...
0x55,0xAA,ALL_SETTING_SW_SMPL_INTERVAL_DEFAULT,ALL_SETTING_SW_CHECK_COUNT_DEFAULT,ALL_SETTING_SW_RENC_CONV_ENABLES_DEFAULT,ALL_SETTING_SW_RENC_CHECK_COUNT_DEFAULT,ALL_SETTING_AN_SMPL_INTERVAL_DEFAULT,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
// SW
...
//
void u_AllSettingInfo_buffClr(UN_ALL_SETTING_INFOS* p_all_infos)
{
  p_all_infos->ALL_Infos.sw_smpl_interval     = 0x00;
  p_all_infos->ALL_Infos.sw_check_count       = 0x00;
  p_all_infos->ALL_Infos.sw_renc_conv_enables = 0x00;
  p_all_infos->ALL_Infos.sw_renc_check_count  = 0x00;
  p_all_infos->ALL_Infos.an_smpl_interval     = 0x00;
}
...
int u_GetAllSettingInfo(UN_ALL_SETTING_INFOS* p_all_info)
{
  EEPROM_ADR adr;
    
  adr = (EEPROM_ADR)(EEPROM_ALL_SETTION_ADR);
  eeprom_n_read(adr  , &p_all_info->ALL_Infos.sw_smpl_interval    , sizeof(p_all_info->ALL_Infos.sw_smpl_interval));
  eeprom_n_read(adr+1, &p_all_info->ALL_Infos.sw_check_count      , sizeof(p_all_info->ALL_Infos.sw_check_count));
  eeprom_n_read(adr+2, &p_all_info->ALL_Infos.sw_renc_conv_enables, sizeof(p_all_info->ALL_Infos.sw_renc_conv_enables));
  eeprom_n_read(adr+3, &p_all_info->ALL_Infos.sw_renc_check_count , sizeof(p_all_info->ALL_Infos.sw_renc_check_count));
  eeprom_n_read(adr+4, &p_all_info->ALL_Infos.an_smpl_interval    , sizeof(p_all_info->ALL_Infos.an_smpl_interval));
